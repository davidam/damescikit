...
#+BEGIN_SRC
$ git clone https://github.com/davidam/damescikit
#+END_SRC

Or you can download from pypi:
#+BEGIN_SRC
...
using scikit. Now you can practice it with this source
...
#+BEGIN_SRC bash
  $ pytest tests/test_models.py::TddInPythonExample::test_models_sgd
#+END_SRC
...
#+BEGIN_SRC
  $ pytest tests/test_models.py::TddInPythonExample::test_models_kernel_approximation  
#+END_SRC
...
#+BEGIN_SRC
$ pytest tests/test_models.py::TddInPythonExample::test_models_gaussiannb
$ pytest tests/test_models.py::TddInPythonExample::test_models_bernoullinb
$ pytest tests/test_models.py::TddInPythonExample::test_models_multinomial
$ wget -c https://raw.githubusercontent.com/davidam/python-examples/refs/heads/master/nlp/nltk/sexmachine.py
...
#+BEGIN_SRC bash
$ pytest tests/test_models.py::TddInPythonExample::test_models_svc
#+END_SRC
...
Execute code! Read code! Modify code!

#+BEGIN_SRC bash
  $ pytest tests/test_models.py::TddInPythonExample::test_models_tree
  $ pytest tests/test_models.py::TddInPythonExample::test_models_tree_iris
  $ pytest tests/test_models.py::TddInPythonExample::test_models_tree_regressor 
#+END_SRC
